...
namespace VCore
{
    ...
    {
        [Header("Signaling")]
        [Tooltip("Shared backend address. When assigned it overrides the host/port below — point this at " +
                 "the same asset as VCoreConnection.")]
        ...
        private IEnumerator ConnectSignaling()
        {
            ...
            var uri = new Uri($"ws://{ResolvedHost}:{ResolvedPort}/ws/signaling");
